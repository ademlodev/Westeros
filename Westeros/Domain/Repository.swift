...
final class LocalFactory: HouseFactory {
    ...
    var seasons: [Season]{
        ...
        let episode1x1 = Episode(title: "Winter Is Coming", emisionDate: dateEpisode!, season: season1)
        dateEpisode = formatter.date(from: "2011/04/24")
        let episode1x2 = Episode(title: "The Kingsroad", emisionDate: dateEpisode!, season: season1)
        ...
        let episode2x1 = Episode(title: "The North Remembers", emisionDate: dateEpisode!, season: season2)
        dateEpisode = formatter.date(from: "2012/04/08")
        let episode2x2 = Episode(title: "The Night Lands", emisionDate: dateEpisode!, season: season2)
        ...
        let episode3x1 = Episode(title: "Valar Dohaeris", emisionDate: dateEpisode!, season: season3)
        dateEpisode = formatter.date(from: "2013/04/07")
        let episode3x2 = Episode(title: "Dark Wings, Dark Words", emisionDate: dateEpisode!, season: season3)
        ...
        let episode4x1 = Episode(title: "Two Swords", emisionDate: dateEpisode!, season: season4)
        dateEpisode = formatter.date(from: "2014/04/13")
        let episode4x2 = Episode(title: "The Lion and the Rose", emisionDate: dateEpisode!, season: season4)
        ...
        let episode5x1 = Episode(title: "The Wars to Come", emisionDate: dateEpisode!, season: season5)
        dateEpisode = formatter.date(from: "2015/04/19")
        let episode5x2 = Episode(title: "The House of Black and White", emisionDate: dateEpisode!, season: season5)
        ...
        let episode6x1 = Episode(title: "The Red Woman", emisionDate: dateEpisode!, season: season6)
        dateEpisode = formatter.date(from: "2016/05/01")
        let episode6x2 = Episode(title: "Home", emisionDate: dateEpisode!, season: season6)
        ...
        let episode7x1 = Episode(title: "Dragonstone", emisionDate: dateEpisode!, season: season7)
        dateEpisode = formatter.date(from: "2017/07/23")
        let episode7x2 = Episode(title: "Stormborn", emisionDate: dateEpisode!, season: season7)
